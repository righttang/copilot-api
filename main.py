...
class Settings(BaseSettings):
    ...
    openai_api_key: str = Field(default="dummy-key", alias="OPENAI_API_KEY")
    big_model_name: str = Field(default="claude-sonnet-4", alias="BIG_MODEL")
    small_model_name: str = Field(default="claude-sonnet-4", alias="SMALL_MODEL")
    base_url: str = Field(default="http://localhost:4142", alias="OPENAI_API_BASE")
    referrer_url: str = "http://localhost:8080/claude_proxy"
    preferred_provider: str = Field(default="openai", alias="PREFERRED_PROVIDER")
